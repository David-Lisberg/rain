...
pub fn load_textures(handle: &mut RainHandle) {
    ...
    handle.load_texture("item_flint_hatchet", "res/texture/item_flint_hatchet.png").expect("Error loading texture.");
    handle.load_texture("item_bone_hatchet", "res/texture/item_bone_hatchet.png").expect("Error loading texture.");
    ...
    handle.load_texture("item_squirrel_pelt", "res/texture/item_squirrel_pelt.png").expect("Error loading texture.");
    handle.load_texture("item_small_bone", "res/texture/item_small_bone.png").expect("Error loading texture.");
    handle.load_texture("item_bone_plate", "res/texture/item_bone_plate.png").expect("Error loading texture.");
...
pub fn load_animations(handle: &mut RainHandle) {
    ...
    handle.load_animation("animation_player_punching_side", "res/animations/player_punching_side.json").expect("Error loading animation");
    handle.load_animation("animation_player_punching_front", "res/animations/player_punching_front.json").expect("Error loading animation");
    handle.load_animation("animation_player_punching_back", "res/animations/player_punching_back.json").expect("Error loading animation");
